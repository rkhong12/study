...
// import BookLayout from "./pages/BookLibrary/BookLayout.jsx";
import LottoLayout from "./pages/Lotto/LottoLayout.jsx";

createRoot(document.getElementById("root")).render(<LottoLayout />);
